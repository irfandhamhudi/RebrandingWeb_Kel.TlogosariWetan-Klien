...
import { getLatestData } from "../utils/data/dataNewsAPI"; // Impor fungsi untuk mengambil data berita
            ...
            <div className="w-full px-5 md:px-28">
              <div className="border border-gray-300 bg-white p-6 text-center">
                <p className="text-lg font-semibold text-gray-600">
                  Berita & Pengumuman Terbaru Belum Tersedia
                </p>
              </div>
            </div>
          ) : (
            <div className="flex flex-col lg:flex-row w-full mx-auto space-y-6 lg:space-y-0 lg:space-x-6 px-5 md:px-28 justify-center">
              <div className="cursor-pointer w-full lg:w-1/2 space-y-1 border border-gray-300 bg-white p-3 sm:p-4 transition-all duration-300 hover:scale-105 animate-fade-in">
                ...
                <div className="py-2 space-y-5 sm:space-y-4">
                  <div className="flex items-start lg:space-y-0 text-xs w-full lg:gap-2 gap-2">
                    <p className="bg-red-100 text-primary py-1 px-2">
                      {newsData[0]?.bidang.name}
                    </p>
                    <p className="bg-gray-200 text-black font-semibold px-4 py-1 text-xs sm:text-xs">
                  ...
                  >
                    ...
                    <div className="flex flex-col space-y-4 sm:space-y-4">
                      <div className="flex items-start lg:space-y-0 text-xs w-full lg:gap-2 gap-2">
                        ...
                        <p className="flex justify-end items-end bg-gray-200 text-black font-semibold px-4 py-1 text-xs">
                          {item.createdAt
                      ...
                      <div className="space-y-2 w-full">
                        <h1
                          onClick={() =>
                            navigate(`/detail-berita/${item.slug}`)
                          }
